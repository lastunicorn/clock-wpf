...
public class NibHand : HandBase
{
    ...
    private StreamGeometry nibGeometry;
    ...
    private static StreamGeometry CreateNibGeometry()
    {
        ...
        using (StreamGeometryContext context = geometry.Open())
        {
            ...
            context.BeginFigure(new Point(startX, startY), true, true);
            ...
            context.LineTo(new Point(-1, -280), true, false);

            // Center line
            context.LineTo(new Point(1, -280), true, false);

            context.LineTo(new Point(1, -249), true, false);
